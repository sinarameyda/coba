...
if menu == "Overview":
    ...
    with c1:
        metric("Total Data", "9.042", "Gambar")
    with c2:
        metric("Dominan", "Organik", "22.74%")
    with c3:
        metric("Reuse/Recycle", "82.26%", "Dapat Dimanfaatkan")
    with c4:
        metric("Residu", "17.74%", "Sulit Diolah")
    ...
    with c1:
        metric("Recycle", "76.89%", "6952 Data")
    with c2:
        metric("Reuse", "12.28%", "1110 Data")
    with c3:
        metric("Reduce", "10.83%", "980 Data")
    ...
    with c1:
        metric("Dominan", "Organik", "2056 Data")
    with c2:
        metric("Proporsi", "22.74%", "Tertinggi")
    ...
    with c1:
        metric("Dapat Dimanfaatkan", "82.26%", "7438 Data")
    with c2:
        metric("Residu", "17.74%", "1604 Data")
